      ...
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-10">
            We&apos;re building GovWin AI: Your intelligent co-pilot designed to find, analyze, and respond to crucial Sources Sought notices — giving you the strategic advantage before the competition even starts.
          </p>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="aspect-video bg-gray-200 rounded-lg shadow-lg flex items-center justify-center">
             ...
             // <ImageFallback src="/images/hero-visual.png" alt="GovWin AI Interface Preview" width={1000} height={563} className="rounded-lg" /> 
          </div>
        </div> 
        */}
      </div>
