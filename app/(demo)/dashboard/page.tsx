  ...
  return (
    <div>
      ...
      <p className="text-lg text-gray-700 mb-8">
        Welcome to the GovCon Agent simulation! Use the sidebar to explore the planned features.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-gray-600">
            This interactive demo uses pre-defined data to illustrate how GovCon Agent aims to function. Click through the different sections to get a feel for the intended workflow.
          </p>
        </div>
      </div>
    </div>
